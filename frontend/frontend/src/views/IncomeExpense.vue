<template>
  <div class="income-expense-view p-2 h-100 d-flex flex-column">
    <div class="d-flex justify-between align-center mb-2">
      <h2 class="m-0" style="font-weight: 600; font-size: 1.5rem;">Доходы и расходы</h2>
      <div class="d-flex align-center gap-3">
        <span v-if="totalCount > 0" class="badge badge-secondary small">{{ totalCount }}</span>
...
.income-expense-view { padding-bottom: 80px; }
.bulk-checkbox {
  width: 16px;
  height: 16px;
  cursor: pointer;

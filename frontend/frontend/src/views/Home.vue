<template>
  <div class="dash">
    ...
    <section class="dash-grid">
      ...
      <aside class="dash-col dash-col--side">
        <article class="dash-panel">
          <div class="dash-panel__head">
            <h3 class="dash-panel__title">Портфель проектов</h3>
        ...
        <article class="dash-panel">
          <div class="dash-panel__head">
            <h3 class="dash-panel__title">Задачи</h3>
        ...
        <article class="dash-panel dash-panel--actions">
          <div class="dash-panel__head">
            <h3 class="dash-panel__title dash-panel__title--accent"><i class="fas fa-bolt"></i> Быстрые действия</h3>
          </div>
...
export default {
  name: 'Home',
  components: { SkeletonLoader, apexchart: VueApexCharts },
  setup() {
...
.dash-chip--muted { color: var(--color-text-muted); background: var(--color-surface-2); }
...
.dash-legend__label { color: var(--color-text-muted); }
...
.dash-bar__label { color: var(--color-text-muted); }

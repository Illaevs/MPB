...
DOMAIN_CONFIG = [
    {
        ...
        'description': 'Аутентификация, пользователи, роли, компании, оргструктура и справочные интеграции.',
        'routers': ['auth', 'users', 'roles', 'companies', 'banks', 'dadata', 'org_structure'],
    },
    {
        'slug': 'crm',
        'title': 'CRM Core API',
        'description': 'Сделки, лиды, этапы, задачи, подзадачи, согласования, продукты, тендеры и исполнение.',
        'routers': [
            'deals', 'leads', 'stages', 'tasks', 'task_subtasks', 'approvals',
            'products', 'task_auctions', 'tenders', 'deal_execution', 'executor',
            'subcontractors', 'subcontractor_stages', 'subcontractor_products',
            'result_reviews', 'kp',
        ],
    },
    {
        ...
        'description': 'Финансы, казначейство, ДДС, штрафы и договоры.',
        'routers': ['finance', 'income_expense', 'penalty_rules', 'contracts'],
    },
    {
        'slug': 'documents',
        'title': 'Document Flow & Storage API',
        'description': 'Реестры документов, шаблоны, исходящие, загрузки, хранилище и файловый каталог.',
        'routers': ['document_registry', 'document_templates', 'outgoing_registry', 'uploads', 'storage', 'files_catalog'],
    },
    {
        'slug': 'communications',
        'title': 'Communications & Notifications API',
        'description': 'Почта, чаты, корпоративная лента, тех. поддержка, уведомления и пользовательские предпочтения уведомлений.',
        'routers': [
            'mail', 'task_messages', 'global_chat', 'feed', 'support',
            'notifications', 'notification_rules', 'notification_preferences',
            'notification_subscriptions', 'telegram_notifications',
        ],
    },
    {
        'slug': 'legal_compliance',
        'title': 'Legal & Compliance API',
        'description': 'Юридическая работа, аккредитации и нормативная база.',
        'routers': ['legal_work', 'accreditations', 'reglaments'],
    },
    {
        'slug': 'hr',
        'title': 'HR & Workforce API',
        'description': 'Профили сотрудников, рабочий день и отсутствия (HR-блок).',
        'routers': ['profiles', 'workday', 'absences'],
    },
    {
        'slug': 'platform',
        'title': 'Platform & Integration API',
        'description': 'Event Bus (outbox/subscriptions), поиск, AI-сервисы, customer portal и data-health диагностика.',
        'routers': ['event_bus', 'search', 'ai', 'customer_portal', 'data_health'],
    },
    {
        'slug': 'analytics',

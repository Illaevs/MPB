...
from app.services.upload_queue import upload_slot
...
async def upload_storage_files(
    ...
    # Bound concurrent uploads so an executor-panel burst queues instead
    # of stampeding storage + SQLite writes.

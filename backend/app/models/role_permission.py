...
class RolePermission(Base):
    ...
    # Edit (write) granularity, mirrors read_*. Implication enforced on save:
    # edit_all => read_all, edit_assigned => read_assigned.
    edit_all = Column(Boolean, default=False, nullable=False)
    edit_assigned = Column(Boolean, default=False, nullable=False)
